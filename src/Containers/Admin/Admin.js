                    ...
                    <Col sm="12">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={event =>
                            this.handleChange(event, "blogTitle")
                          }
                        />
                        <label>Date:</label>
                        <input
                          ...
                          className="form-control"
                          onChange={event =>
                            this.handleChange(event, "blogDate")
                          }
                          type="date"
                        />
                      </div>
                  ...
                  <Row>
                    <Col sm="12">
                      <div className="form-group">
                        ...
                        <input
                          onChange={event =>
                            this.fileChangedHandler(event, "pressImage")
                          }
                          className="form-control"
                          type="file"
                        />
                      ...
                      <div className="form-group">
                        <Col sm="12">
                          ...
                          <input
                            className="form-control"
                            onChange={event =>
                              this.handleChange(event, "eventTitle")
                            }
                          />
                        </Col>
                    ...
                    <Col sm="12">
                      <Col sm="12" md="6">
                        ...
                        <input
                          className="form-control"
                          onChange={event =>
                            this.handleChange(event, "shopName")
                          }
                        />
                      </Col>
                      <div className="form-group">
                        ...
                        <input
                          onChange={event =>
                            this.fileChangedHandler(event, "shopImage")
                          }
                          className="form-control"
                          type="file"
                        />
                      ...
                      <Col sm="12" md="6">
                        ...
                        <input
                          className="form-control"
                          onChange={event =>
                            this.handleChange(event, "shopQuantity")
                          }
                        />
                      </Col>
                      <Col sm="12" md="6">
                        ...
                        <input
                          className="form-control"
                          onChange={event =>
                            this.handleChange(event, "shopPrice")
                          }
                          min="0.01"
                          step="0.01"
                          max="2500"
                      ...
                      <Col sm="12" md="6">
                        ...
                        <input
                          className="form-control"
                          onChange={event =>
                            this.handleChange(event, "shopCategory")
                          }
                        />
                      </Col>
                      <RichTextEditor
